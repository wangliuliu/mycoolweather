...
/**
 * 由于服务器返回的省市县数据都是“代号|城市，代号|城市”这种格式的，所以用本类来解析和处理这种数据
 * 
...
public class Utility {
	...
	//将解析后的天气数据保存到sharedPreference中
	public synchronized static void saveWeatherInfo(Context context, String cityName,
